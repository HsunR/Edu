...
export function getMenu(menuId: string) { return request.get(`/system/menu/${menuId}`) }
...
export function delMenu(menuId: string) { return request.delete(`/system/menu/${menuId}`) }
export function treeselect() { return request.get('/system/menu/treeselect') }
export function roleMenuTreeselect(roleId: string) { return request.get(`/system/menu/roleMenuTreeselect/${roleId}`) }
