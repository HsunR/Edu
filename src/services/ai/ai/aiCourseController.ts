...
export async function doChatByStream(
  ...
  return request<API.BaseResponseString[]>(`/aiCourse/doChatByStream`, {
    method: "GET",
    params: {
      ...params,
    },
...
export async function doChatByStreamMono(
  ...
  return request<API.BaseResponseFluxString>(`/aiCourse/doChatByStreamMono`, {
    method: "GET",
    params: {
      ...params,
    },
...
export async function doChatWithRagByStream(
  ...
  return request<API.BaseResponseString[]>(`/aiCourse/doChatWithRagByStream`, {
    method: "GET",
    params: {
      ...params,
    },
...
export async function doChatWithToolAndRag(
  ...
  return request<API.BaseResponseString[]>(
    `/aiCourse/doChatWithToolAndRagByStream`,
    {
      method: "GET",
      params: {
        ...params,
...
export async function uploadChat(
  ...
  return request<API.BaseResponseString[]>(`/aiCourse/uploadChat`, {
    method: "POST",
    headers: {
