...
public class StudentLearningServiceImpl implements IStudentLearningService {
    ...
    public List<MasteryOverviewVO> getWeakPoints(Long studentId, Long classId) {
        validateClassMember(studentId, classId);
        return learningQuerySupport.listWeakPoints(studentId, classId, learningProperties.getWeakMasteryThreshold());
    }
    ...
    public Page<WrongRecordVO> pageWrongRecords(Long studentId, WrongRecordQueryRequest request) {
        ...
        return learningQuerySupport.pageWrongRecords(studentId, request);
    }
    ...
    public WrongStatsVO getWrongStats(Long studentId, WrongStatsQueryRequest request) {
        ...
        return learningQuerySupport.statWrongRecords(studentId, request);
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public void resolveWrongRecord(Long studentId, Long wrongId) {
        LpWrongRecord wrongRecord = learningQuerySupport.getOwnedWrongRecord(studentId, wrongId);
